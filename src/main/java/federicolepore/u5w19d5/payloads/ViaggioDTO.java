...
public record ViaggioDTO(
        ...
        @NotNull(message = "Devi inserire una data, e attento che tra 21 ottobre e 21 novembre c'è un mese di differenza, attento anche a non confondere giugno con ferragosto ")
        @Future
        LocalDate data,
